...
#+RESULTS:
[[file:None]]
[[./home/anndy19/CityWeather/weather-site/public/images/temperature.png]]
...
# Define el tamaño de la figura de salida
fig = plt.figure(figsize=(8,6))
plt.plot(df['datetime'], df['main_humidity'], label='Humidity')  # Ajusta según tus datos
...
fname = '/home/anndy19/CityWeather/weather-site/content/images/humidity.png'
plt.savefig(fname)
